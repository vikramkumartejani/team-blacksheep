...
const CookiesModal: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center px-4 md:px-5">
            <div className="absolute inset-0 bg-[#00000066] backdrop-blur-[4px]" onClick={() => setIsVisible(false)} />
            ...
            <div className="bg-[#292930] rounded-[20px] w-full max-w-[649px] relative z-10 animate-in fade-in zoom-in-95 duration-200">
                <div className='bg-[#1D1D1D80] px-5 py-2.5 rounded-t-[20px] flex justify-end mb-2.5'>
                    <button onClick={() => setIsVisible(false)} className='text-white hover:text-white/80 bg-[#1F1E24B2] w-[42px] h-[42px] rounded-[10px] flex items-center justify-center'>
                ...
                <div className='p-5 space-y-[37px]'>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                        ...
                        <button
                            onClick={() => setIsVisible(false)}
                            className="flex-1 w-full bg-[#686873] hover:bg-[#7A7A85] transition-colors text-white py-4 md:py-[18px] rounded-[10px] text-[16px] md:text-[18px] font-medium"
                        >
                            Accept all
                        </button>
                    </div>
